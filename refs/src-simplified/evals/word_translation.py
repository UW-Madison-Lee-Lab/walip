...
def get_csls_word_translation(src_id_lst, emb1, emb2, sim_score='csls'):
    """
    ...
    # nearest neighbors
    if src_id_lst is None:
        src_id_lst = np.arange(emb1.shape[0])
    query = emb1[src_id_lst]
    ...
    # contextual dissimilarity measure
        ...
        scores = query.mm(emb2.transpose(0, 1))
        scores.mul_(2)
        scores.sub_(average_dist1[src_id_lst][:, None])
