...
def generate_path(ftype, opts):
    ...
    if ftype.startswith('emb'):
        ...
        elif ftype == 'emb_howtowtext': # fasttext
            fdir = f'howtowtext/{opts["word_data"]}/'
            fname = f'howtowtext_{opts["word_data"]}_{opts["src_lang"]}_{opts["tgt_lang"]}_{opts["lang"]}_{opts["data_mode"]}.npy'
